<?php 
	$title = (isset($og_title)) ? $og_title : "Snaphappi &middot; Preview";
	$description = (isset($og_description)) ? $og_description : "
	Test-drive some of the new features under development at Snaphappi. Use our Guest accounts for easy access, and a Reset button is provided so you're always in control. 
	";
...
// $this->Html->css($min, null, array('inline' => false));		
	...
	if ( Configure::read('debug') ) {
		$js_bottom[] = 'http://snappi.snaphappi.com/min/b=static/js&f=bootstrap/modernizr-2.6.2-respond-1.1.0.min.js,bootstrap/bootstrap.js,bootstrap/font-checker.js,bootstrap/jquery.cookie.js,bootstrap/jquery.scrollTo-1.4.3.1-min.js,TouchSwipe-Jquery-Plugin-master/jquery.touchSwipe.min.js&123';		$js_bottom[] = 'base';
